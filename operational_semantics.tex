...
\inference{E,F |- C: False }
		   {E,F |- \text{while}(C) \text{ do } S \text{ od } : E, F}
...
\inference{E,F |- C: True \\
		   E,F |- S : E^\prime, F \\
		   E^\prime, F |- \text{while}(C) \text{ do } S \text{ od } : E^{\prime\prime}, F}
		   {E,F |- \text{while}(C) \text{ do } S \text{ od } : E^{\prime\prime}, F}	  
